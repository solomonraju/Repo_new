...
package fl.video {
	...
	public class VideoPlayer extends Video {
		...
		public override function get videoWidth():int {
			if (_readyDispatched) _videoWidth = super.videoWidth;
			return _videoWidth;
		}
		...
		public override function get videoHeight():int {
			if (_readyDispatched) _videoHeight = super.videoHeight;
			return _videoHeight;
  		}
		...
		flvplayback_internal function doAutoResize(e:TimerEvent=null):void {
			...
			case VideoScaleMode.MAINTAIN_ASPECT_RATIO:
			default:
				var newWidth:Number = (_videoWidth * _registrationHeight / _videoHeight);
				var newHeight:Number = (_videoHeight * _registrationWidth / _videoWidth);
